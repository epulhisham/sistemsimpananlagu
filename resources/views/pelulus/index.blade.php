                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-item-center">
                                ...
                                <a href="/lagu/{{ $song->id }}/edit?page={{ request()->get('page') }}" class="badge bg-warning link-light mx-1">
                                    <span data-feather="edit-3" class=""></span>
                                </a>
                                <a href="/pelulus-lagu/{{ $song->id }}/edit?page={{ request()->get('page') }}" class="badge bg-info link-light mx-1">
