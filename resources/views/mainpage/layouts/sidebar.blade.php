<div>
  <div class="bg-light" id="mySidenav" style="width: 230px;  min-height: 100%; position:fixed; top:0; left:0; z-index:1; overflow-x: hidden; transition: 0.5s;">
    ...
    <ul class="nav nav-pills flex-column mb-auto mt-3">
      <li class="nav-item">
        @can('admin')
          <a class="nav-link {{ Request::is('/admin') ? 'active' : '' }} link-dark" aria-current="page" href="/admin">
            <span data-feather="users"></span>
            Senarai Pengguna
          </a>
        @endcan
        @can('admin')
          <a class="nav-link {{ Request::is('/meluluskan') ? 'active' : '' }} link-dark" aria-current="page" href="/pelulus-lagu">
