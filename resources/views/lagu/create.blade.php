        ...
        <form method="post" action="/lagu" class="mb-5" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <div class="mb-3">
                    ...
                    <input class="form-control @error('lagu') is-invalid @enderror" type="file" id="lagu" name="lagu" multiple required> 
                    <!-- {{-- @foreach($errors->get('lagu[][0]') as $error)
                    <li>{{ $error }}</li>
                    @endforeach --}} -->
                    @error('lagu')
                    <div class="invalid-feedback">
            ...
            <div class="mb-3">
                <div class="mb-3">
                    ...
                    <input class="form-control @error('fail_lagu') is-invalid @enderror" type="file" id="fail_lagu" name="fail_lagu" multiple required>
                    @error('fail_lagu')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>      
